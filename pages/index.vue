  ...
  <div class="min-h-screen bg-background text-text transition-all duration-300 overflow-x-hidden">
    ...
    <main class="mt-24 px-[5%]">
      ...
      <section class="py-20 max-w-7xl mx-auto">
        <h2 class="text-4xl font-bold tracking-tight mb-12">Why 10 Bit Technology?</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="feature-card bg-secondary p-8 rounded-lg transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
            <div class="text-4xl text-accent mb-6">◉</div>
            <h3 class="text-2xl font-semibold mb-4">Future-Ready Solutions</h3>
            <p>Adaptive technology that evolves with your needs through our comprehensive ecosystem.</p>
          </div>
          <div class="feature-card bg-secondary p-8 rounded-lg transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
            <div class="text-4xl text-accent mb-6">◈</div>
            <h3 class="text-2xl font-semibold mb-4">Advanced security</h3>
            <p>Enterprise-grade protection with zero-trust architecture and encryption.</p>
          </div>
        </div>
      </section>
    </main>
